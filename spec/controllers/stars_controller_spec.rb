...
describe StarsController do
  ...
  describe "GET 'destroy'" do
    ...
    it "returns http success" do
      get 'destroy', :volunteer_id => @volunteer.id, :id => FactoryGirl.create(:star, :volunteer => @volunteer)
      response.should be_success
    end
    ...
    it "destroys the appropriate star" do
      ...
      expect {get 'destroy', :volunteer_id => @volunteer.id, :id => star.id}.to change(Star, :count).by(-1)
